...
db.restaurantes.find({}, {restaurante_id: 1, name: 1, borough: 1, cuisine: 1, _id: 0})
db.restaurantes.find({}, {restaurante_id: 1, name: 1, borough: 1, "address.zipcode": 1, _id: 0})
...
db.restaurants.find({$and:[{'address.coord.1': {$lt: -65.754168}},{'grades.score': {$gt: 70}},{cuisine: {$ne:'American '}}]},{})
...
db.restaurants.find({borough: /^(?!.*\bStaten Island\b)(?!.*\bQueens\b)(?!.*\bBronx\b)(?!.*\bBrooklyn\b).*$/},{restaurant_id: 1, name: 1, borough: 1, cuisine: 1, _id:0})
db.restaurants.find({'grades.score': {$lt: 10}},{restaurant_id: 1, name: 1, borough: 1, cuisine: 1, _id:0})
db.restaurants.find({$or: [{cuisine: /(Seafood|American|Chinese)/}, {name: /Wil/}]},{restaurant_id: 1, name: 1, borough: 1, cuisine: 1, _id:0})
...
db.restaurants.find({'address.coord.1': {$gt: 42, $lt:52 }},{restaurant_id: 1, name: 1, 'address.street': 1, 'address.building': 1, 'address.coord': 1, _id:0})
